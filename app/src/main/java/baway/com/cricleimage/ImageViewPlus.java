...
public class ImageViewPlus extends ImageView{
    ...
    public ImageViewPlus(Context context, AttributeSet attrs) {
        ...
        mBorderColor = ta.getColor(R.styleable.ImageViewPlus_borderColor, 0x999);
        mBorderWidth = ta.getDimensionPixelSize(R.styleable.ImageViewPlus_borderWidth, dip2px(10));
        ta.recycle();
    }
